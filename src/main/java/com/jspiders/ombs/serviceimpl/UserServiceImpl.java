...
//	    }
	  ...
	  @Override
	  public ResponseEntity<ResponseStructure<UserResponseDTO>> deleteUser(String email) throws UserNotFoundException {
	      User user = userRepo.findByUserEmail(email);
	      ...
	      if (user != null && user.getUserrole().getRole().equalsIgnoreCase("Admin")) {
	          ...
	          ResponseStructure<UserResponseDTO> responseStructure = new ResponseStructure<>();
	          responseStructure.setData(response);
	          responseStructure.setMessage("User soft deleted successfully");
	  ...
	  @Override
	  public ResponseEntity<ResponseStructure<UserResponseDTO>> updateUser(String email, UserRequestDTO userRequestDTO) throws UserNotFoundException {
	      User user = userRepo.findByUserEmail(email);
	  ...
	  public ResponseEntity<ResponseStructure<List<UserResponseDTO>>> getAllUsers() {
	      ...
	      List<UserResponseDTO> adminUserResponseDTOs = new ArrayList<>();
