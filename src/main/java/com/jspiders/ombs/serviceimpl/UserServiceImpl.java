...
public class UserServiceImpl implements UserService {
	...
	@Override
	public ResponseEntity<ResponseStructure<ForgetEmailResponse>> getEmail(String email) {
		User user = repo.findByUserEmail(email);
		...
		if (user != null   ) {
			...
			ForgetEmailResponse emailResponse = new ForgetEmailResponse();
			emailResponse.setUserId(user.getUserId());
			emailResponse.setCreateBy(user.getCreatedBy());
			emailResponse.setUserEmail(user.getUserEmail());
			emailResponse.setCreateDateTime(user.getCreatedDateTime());
			
			ResponseStructure<ForgetEmailResponse> responseStructure = new ResponseStructure<>();
